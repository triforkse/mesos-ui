...
export default class AppIntentAdd extends Component {
  ...
  render() {
    ...
    return (<div className="app-intent-add">
      <div className="app-intent-add__available-frameworks" onDragOver={this.allowDrop} onDrop={this.dropRemove.bind(this)}>
      ...
      <div className="app-intent-add__selected-frameworks" onDragOver={this.allowDrop} onDrop={this.dropAdd.bind(this)}>
